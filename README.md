...
1. Lakukan pembersihan teks mentah menggunakan fungsi clean_text di awal proses.
2. Lakukan pembagian data (Data Split) untuk memastikan evaluasi model yang objektif.
3. Terapkan TfidfVectorizer dengan parameter ngram_range=(1,2) untuk menangkap konteks kata yang lebih luas.
4. Gunakan teknik augmentasi data (Pseudo-labeling) untuk memperbanyak data latih secara otomatis.
5. Evaluasi model menggunakan metrik akurasi, laporan klasifikasi, dan skor ROC-AUC.
